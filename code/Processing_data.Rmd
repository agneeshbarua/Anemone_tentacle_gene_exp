...
```{r, message=F,eval=F}
Enqua_tpm_exp<-rbind(read_tsv(file.path(Kallisto_path,"Entacmea_quadricolor/results/Equa_3_S3_L002/abundance.tsv")) %>% mutate(tissue = "Enqua_tentacles1") %>% mutate(tpm10k = tpm*n()/10e4),
